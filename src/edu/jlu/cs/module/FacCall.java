...
public class FacCall { 
   ...
   * @param args 
   */
  public static String work(String internal_ID,String user_FAC_ids,String images)
  {
	  JSONObject jsonObject=new JSONObject();
	  String urlPath=PATH+"?internal_ID="+internal_ID+"&user_FAC_ids="+user_FAC_ids;
	  jsonObject.put("images", images);
	  String result = FacCall.sendPostMessage(jsonObject.toString(),urlPath); 
	  return result;
  }
} 